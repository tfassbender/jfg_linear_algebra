...
public class Line2D {
	 ...
	 * 
	 * @return The crossing point of the two lines. If there is no crossing point because of parallel lines or there are infinite crossing points
	 *         because the lines are equal all coordinates are Double.NaN.
	 */
	...
	protected Vector2D calculateCrosspointUnchecked(Line2D line) {
